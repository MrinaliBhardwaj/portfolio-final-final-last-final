// The four third-party brand marks, vendored.
//
...
// One 24x24 frame for all four — every Simple Icons glyph is a single path on
// that viewBox, so there is nothing per-icon here but the outline itself.
