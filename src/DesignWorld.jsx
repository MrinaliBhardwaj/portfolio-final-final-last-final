...
// nothing from the tech world leaks in here.
...
export default function DesignWorld() {
  return (
    <div className="dw">
      ...
      {/* ============ statement hero ============ */}
      <section className="dw-hero" aria-label="Introduction">
        <motion.h1
      ...
      {/* ============ selected work ============ */}
      <section className="dw-section" aria-label="Selected work">
      ...
      {/* ============ capabilities ============ */}
      <section className="dw-section dw-cap" aria-label="Capabilities">
      ...
      {/* ============ about ============ */}
      <section className="dw-section dw-about" aria-label="About">
