...
// exactly as shipped. Sized/coloured for this project via props in GalleryWorld.
import { useEffect, useMemo, useRef, useCallback } from 'react';
import { useGesture } from '@use-gesture/react';
import './DomeGallery.css';

// The upstream component shipped seven hardcoded demo images here — six
// Unsplash hotlinks and one pbs.twimg.com URL — as the `images` default.
// They are gone, and the default is now empty, for three reasons:
//
//   · GalleryWorld ALWAYS passes `images`, so they never rendered. They were a
//     second, invisible copy of a list that lives in GalleryWorld.jsx — the
//     same two-sources-of-truth problem that made the layers panel drift.
//   · They were seven remote subresources compiled into the bundle of a site
//     whose build now refuses remote subresources on principle.
//   · One was somebody else's Twitter media, hotlinked. Those URLs rot, and it
//     was never ours to serve.
//
// Empty is the honest default: forget the prop and you get an empty dome, not
// a stranger's photographs quietly standing in for her work.
